...
import { remarkLatexTextMacros } from '@/lib/remarkLatexTextMacros'

import 'katex/dist/katex.min.css'

// Markdown + LaTeX 渲染（服务端渲染，客户端不闪烁）。
// react-markdown 默认不渲染原始 HTML，天然防注入；公式走统一 @/lib/katex 配置。
// 文本流里的 LaTeX 文本宏（\textbf/\textit/\emph/\textrm/\textsf/\texttt）在
// remark 阶段被 remarkLatexTextMacros 转为 Markdown 等价物（task #15）。
